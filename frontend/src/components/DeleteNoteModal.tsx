    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-5 px-6 pb-6 pt-[22px]">
          <div className="flex items-center gap-3.5 overflow-hidden rounded-2xl border border-[var(--border-subtle)] bg-[var(--text-primary)]/[0.03] p-3.5">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-0.5 truncate text-xs text-[var(--text-secondary)]">{purpose || 'No purpose specified'}</div>
            </div>
          </div>

          <p className="m-0 text-[13px] leading-relaxed text-[var(--text-secondary)]">
            This note will be moved to <b className="text-[var(--text-primary)]">Trash</b>. You can restore it within 30 days.
          </p>
